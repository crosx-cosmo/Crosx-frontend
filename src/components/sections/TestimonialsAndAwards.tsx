            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <figcaption className="mt-6 flex items-center gap-3">
                  <span className="relative grid size-11 shrink-0 place-items-center overflow-hidden rounded-full border border-brand/40 bg-surface-2 font-display text-sm font-bold text-brand">
                    {active.avatar ? (
                      <img
                        src={active.avatar}
