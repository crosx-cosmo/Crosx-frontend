          ...
          >
            <div className="glass shadow-lux relative rounded-3xl p-4 sm:p-5">
              ...
              <div className="mt-3 grid grid-cols-2 gap-3">
                <div className="plate rounded-2xl px-4 py-3">
                  <p className="text-[11px] uppercase tracking-widest text-muted-foreground">
                    Conversion
                  </p>
                  <p className="mt-0.5 font-display text-lg font-bold text-foreground">8.6%</p>
                </div>
                <div className="plate rounded-2xl px-4 py-3">
                  <p className="text-[11px] uppercase tracking-widest text-muted-foreground">
                    ROAS
                  </p>
                  <p className="mt-0.5 font-display text-lg font-bold text-brand">3.4x</p>
                </div>
              </div>
            </div>
          </div>
