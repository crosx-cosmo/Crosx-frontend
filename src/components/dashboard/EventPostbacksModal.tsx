...
import { useCampaignPostbacks, type PostbackConfig } from "@/lib/campaign-postback-store";
...
export function EventPostbacksModal({
  ...
  const { forEvent, global, removePostback, toggleActive, testPostback } = useCampaignPostbacks();
