...
import {
  CampaignPostbackPanel,
  CampaignSpeedAnalyzer,
} from "@/components/dashboard/CampaignPostbackPanel";
          ...
          campaign.joined ? (
            ...
            <ActionButton
              ...
              onClick={() => {
                ...
                toast.success(`Applied to ${campaign.name}`, {
          ...
          <Panel
            ...
            description={
              campaign.joined
                ...
                : "Apply to this campaign to start generating traffic and earnings."
            }
          >
